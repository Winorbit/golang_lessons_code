...
func CreateUserProfile(username string, level int) User{
	new_user := User{Username: username,
				 	 Level: level}
	return new_user}

func SendSentencesToUser(user User, word string, sentences []Sentence){
...
func StartDialog(){
    ...
    fmt.Println(user)
    SendSentencesToUser(user, word, quotes)}

func main() {StartDialog()}